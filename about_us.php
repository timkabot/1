...
<div class = "col-md-12 all container" >
     ...
     <div class = "col-md-7 bord" style = " margin-top:10px; ">
       ...
       <div class = "col-md-12 b_border">
       	...
       	<img src="img/ava2.jpg" class=" image-rounded " style="max-width: 50%;height:200px;margin: 15px;" align="left">
        Name : Nursultan<br>
        Surname : Zhumagul<br>
        University : Suleyman Demirel University<br>
        Hobby and Work : Travelling<br>
        Age : 20<br>
        City : Almaty <br>
        College : Suleyman Demirel College<br>
        Languages : Turkish, Russian, English, Kazakh <br>
        Birthday : 21 of July<br><br>
        Why have I been traveling for so long?<br>

Because I'm curious about our planet. I want to take risks, meet interesting people, challenge myself, see amazing things, explore the world, and learn as much as a can. Not to mention have a bit of fun along the way!<br>
         Subscribe To My Newsletter!
          <input type="password" class="form-control" id="search" placeholder="Enter email">
          I hope you'll follow along with me on my journey!
